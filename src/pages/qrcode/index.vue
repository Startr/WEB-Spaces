...
export default {
  ...
  data: function () {
    return {
      ...
      config: {
        meetingSettings:
          "#jitsi_meet_external_api_id=0&config.requireDisplayName=false&amp;config.startAudioMuted=6&amp;config.disableAudioLevels=true&amp;interfaceConfig.DISABLE_VIDEO_BACKGROUND=true&interfaceConfig.SHOW_CHROME_EXTENSION_BANNER=false&config.disableDeepLinking=true&setVideoQuality=720",
      },
    };
  },
  computed: {
